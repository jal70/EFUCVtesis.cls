...
\caption[Sello oficial de la UCV (nombre corto para el índice de figuras)]{Sello oficial de la UCV. No tiene nada que ver con lo dicho por Klein en \cite{blackholes} (caption extendido para el texto del documento) \label{selloUCV}}
\end{center}
\end{figure}
