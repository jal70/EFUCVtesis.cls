...
%
\cleardoublepage
\veredicto{otro} %Si se escoge \veredicto{final}, se renumeran la páginas para incluir el veredicto luego de la portada. Si se escoge \veredicto{borrador} se inserta la carta de autorización del tutor. Para cualquier otra elección inserta una página con textoprueba.tex
%
%\input{textoveredicto.tex}
\cleardoublepage
\input{TEG_ejemplo/paginalibre.tex} % Página para incluir cualquier idea o cita que el estudiante desee y no tenga lugar en el resto del documento
%
\cleardoublepage
\input{TEG_ejemplo/agradecimientos.tex} % Agradecimientos
%
\cleardoublepage
\input{TEG_ejemplo/resumennew} %resumen menor a 200 palabras
\cleardoublepage
...
%%%%%%%%%%%%%%%%
%
\input{TEG_ejemplo/nombrecapitulouno.tex}
%
\input{TEG_ejemplo/nombrecapitulodos.tex}
%
%%%%%%%%%%%%%%%%%%%%
%% Apéndices
%%%%%%%%%%%%%%%%%%%
%
\appendix
\input{TEG_ejemplo/modeloApendice.tex} %cada capítulo incluido es un nuevo apendice
\input{TEG_ejemplo/portadaconmedidas.tex}
%
%%%%%%%%%%%%%%%%%%%
