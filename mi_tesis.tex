...
%
%
\titulo{{\bfseries \uppercase{\expandafter{Estudio del Superconductor Intermetálico ternario}} \ce{La3Pd4Si4} \uppercase{\expandafter{mediante la dependencia con la temperatura de la longitud de penetración magnética}}}}
%%%%%%%%%%%%%%%
% Hay que escribir el título con cuidado en el orden que actúan los comandos. El ejemplo contempla el nombre de un compuesto químico, que se debe dejar fuera de la acción del \uppercase{\expandafter{#1}}, ya que destruye la expresión
%%%%%%%%%%%%%%%
%
...
\cleardoublepage
\input{mi_tesis/paginalibre.tex} % Página para incluir cualquier idea o cita que el estudiante desee y no tenga lugar en el resto del documento
%
\cleardoublepage
\input{mi_tesis/agradecimientos.tex} % Agradecimientos
%
\cleardoublepage
\input{mi_tesis/resumennew} %resumen menor a 200 palabras
\cleardoublepage
...
%%%%%%%%%%%%%%%%
%
\input{mi_tesis/nombrecapitulouno.tex}
%
\input{mi_tesis/nombrecapitulodos.tex}
%
%%%%%%%%%%%%%%%%%%%%
%% Apéndices
%%%%%%%%%%%%%%%%%%%
%
\appendix
\input{mi_tesis/modeloApendice.tex} %cada capítulo incluido es un nuevo apendice
\input{mi_tesis/portadaconmedidas.tex}
%
%%%%%%%%%%%%%%%%%%%
